...
void saveAllSlices(char verticalAxis, int directionVertial, char horizontalAxis, int directionHorizontal, MedicalImage *image3D, const char * directory, int nbits){
	char *extension = ".png";
	char *name = "slice";
	char num[15];
	char str[80];
	...
	if(verticalAxis != 'z' && horizontalAxis != 'z'){
		...
		for(int i=0; i<image3D->nz; i++){
			slice = getSliceZPositive(i,verticalAxis,directionVertial,horizontalAxis,directionHorizontal,image3D);
			sprintf(num,"%d",i);
			strcpy(str,directory);
			strcat(str,name);
			strcat(str,num);
			strcat(str,extension);
			//WriteGrayImage(slice, str);
			writeGrayImagePng(slice,nbits,str);
		...
		for(int i=0; i<image3D->nz; i++){
			slice = getSliceYPositive(i,verticalAxis,directionVertial,horizontalAxis,directionHorizontal,image3D);
			sprintf(num,"%d",i);
			strcpy(str,directory);
			strcat(str,name);
			strcat(str,num);
		...
		for(int i=0; i<image3D->nz; i++){
			slice = getSliceXPositive(i,verticalAxis,directionVertial,horizontalAxis,directionHorizontal,image3D);
			sprintf(num,"%d",i);
			strcpy(str,directory);
			strcat(str,name);
			strcat(str,num);
